...
function Bill() {
  ...
  const handleInputChange = (e, index, field) => {
    ...
    if (field === "quantity") {
      ...
      //     newItem.price = data[i].sellingPrice * newItem.quantity;
      //     break;
      //   }
      // }
    }
...
//     if (foundItem) {
//       newItem.quantity = 1;
//       newItem.price = !foundItem ? 3 : foundItem.sellingPrice;
//       // newItem.id = foundItem.id;
//       // setId(foundItem.quantity);
...
//   if (existingItemIndex !== -1) {
//     updatedItems[existingItemIndex].quantity =
//       Number(updatedItems[existingItemIndex].quantity) + Number(1);
//     updatedItems.splice(index, 1);
//   }
